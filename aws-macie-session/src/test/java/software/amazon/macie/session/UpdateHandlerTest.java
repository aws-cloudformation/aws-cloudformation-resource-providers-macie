...
public class UpdateHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        SdkResponse getMacieSessionResponse = GetMacieSessionResponse.builder()
            ...
            .build();
        SdkResponse updateMacieSessionResponse = UpdateMacieSessionResponse.builder()
            .sdkHttpResponse(SdkHttpResponse.builder().statusCode(200).build())
            .build();
        doReturn(getMacieSessionResponse).when(proxy).injectCredentialsAndInvokeV2(any(GetMacieSessionRequest.class), any());
        doReturn(updateMacieSessionResponse).when(proxy).injectCredentialsAndInvokeV2(any(UpdateMacieSessionRequest.class), any());
